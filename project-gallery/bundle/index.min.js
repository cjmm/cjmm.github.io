...
$(function () {
    ...
    function mainRender() {
        ...
        var caseData = [{
            ...
            device: '',
            compatibility: '',
            others: '<div class="cases">' + '<div class="col-title">Projects</div>' + '<div class="tip"></div>' +
            // '<div class="tip2"></div>' +
            '</div>'
        }, {
        ...
        for (var i = 0, j = arrayLen; i < j; i++) {
            ...
            if (url !== null) {
                ...
                // <img data-src="path/to/picture-1.jpg" class="swiper-lazy">
                '<img data-src="' + pic + '" class="swiper-lazy" with="280" height="280"></a>' + '<div class="swiper-lazy-preloader"></div>' + '<h2>' + title + '</h2>' + device + compatibility + others +
                //'   </a>' +
                '</div>';
            } else {
    ...
    function galleryRender() {
        ...
        var galleryData = [{
            ...
            device: '',
            compatibility: '',
            others: '<div class="cases">' + '<div class="col-title">Gallery</div>' + '<div class="tip"></div>' +
            // '<div class="tip2"></div>' +
            '</div>'
        }, {
        ...
        for (var i = 0, j = arrayLen; i < j; i++) {
            ...
            if (pic !== null) {
                ...
                // '<img src="' + pic + '" alt="' + title + '" /></a>' +
                // <img data-src="path/to/picture-1.jpg" class="swiper-lazy">
                '<img data-src="' + pic + '" class="swiper-lazy" with="100%" height="auto"></a>' + '<div class="swiper-lazy-preloader"></div>' + '<p class="t">' + title + '</p>' +
                // device +
                // compatibility +
                // others +
                //'   </a>' +
                ...
                tmp += '<div class="swiper-slide galleryFace">' + '<div class=boxIn>' + others + '</div>' + '</div>';
            }
        }
