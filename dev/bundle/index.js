...
var device = {
    ...
    html: function html(p) {
        ...
        _this.$myWechat.find('.wechatImg').css({
...
function mainRender() {
    ...
    var caseData = [{
        ...
        device: '',
        compatibility: '',
        others: '<div class="cases">' + '<div>项目展示</div>' + '<div class="tip"></div>' + '<div class="tip2"></div>' + '<div class="tip3Box">' + '<div class="tip3">' + '<div class="iconBlueArrowUp"></div>' + '<div class="iconBlueArrowUp iconBlueArrowUp2"></div>' + '</div>' + '</div>' + '</div>'
    }, {
    ...
    for (var i = 0, j = arrayLen; i < j; i++) {
        ...
        if (url !== null) {
            ...
            if (array.device === null) {
                ...
                device = '<p>设备：<span>' + array.device + '</span></p>';
            }

            if (array.compatibility === null) {
                compatibility = '';
            } else {
                compatibility = '<p>兼容：<span>' + array.compatibility + '</span></p>';
            }
            ...
            '<a href="' + url + '" title="' + title + '">' + '<img src="' + pic + '" alt="' + title + '" /></a>' + '<h3>' + title + '</h3>' + device + compatibility + others +
            //'   </a>' +
            '</div>';
        } else {
            tmp += '<div class="swiper-slide">' + '<div class=boxIn>' + others + '</div>' + '</div>';
        }
    }
